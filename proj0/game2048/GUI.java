...
class GUI extends TopLevel implements Observer {
    ...
    public void keyPressed(String unused, KeyEvent e) {
        switch (e.getKeyCode()) {
            case KeyEvent.VK_UP:    _pendingKeys.offer("Up");    break;
            case KeyEvent.VK_DOWN:  _pendingKeys.offer("Down");  break;
            case KeyEvent.VK_LEFT:  _pendingKeys.offer("Left");  break;
            case KeyEvent.VK_RIGHT: _pendingKeys.offer("Right"); break;
            default:
